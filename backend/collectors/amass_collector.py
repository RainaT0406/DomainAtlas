    ...
    try:
        ...
        while process.poll() is None:
            ...
            try:
                ...
                print(
                    f"[!] Error reading Amass output: {error}"
                )
                break
        ...
        for line in output.splitlines():
            ...
            # Amass passive output is expected in this format:
            # subdomain.example.com (FQDN) --> source
            if " (FQDN) --> " not in line:
                continue
        ...
        print("[!] Amass executable not found.")
        print("[!] Continuing without Amass.")
        return []

    except Exception as error:
        print(f"[!] Amass failed: {error}")
        print("[!] Continuing without Amass.")
        return []
